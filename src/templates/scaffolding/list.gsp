...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="\${createLink(uri: '/indexSystem')}"><g:message code="default.home.label"/></a></li>
					...
					<%  props.eachWithIndex { p, i ->
							if (i == 0) { 
								if (p.manyToOne || p.oneToOne) { %>
									<td><g:link action="show" id="\${${propertyName}.id}">\${${propertyName}?.${p.name}?.displayString?.encodeAsHTML()}</g:link></td>
								<%          } else { %>
